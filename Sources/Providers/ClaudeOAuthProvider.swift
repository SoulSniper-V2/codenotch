...
actor ClaudeOAuthProvider: UsageProvider {
    ...
    /// Doubles on every consecutive 429, up to 15 minutes.
    static func backoff(forAttempt attempt: Int, floor: TimeInterval = 60, retryAfter: TimeInterval?) -> TimeInterval {
