...
enum Log {
    static let usage = Logger(subsystem: "com.soulsniper.codenotch", category: "usage")
    static let sessions = Logger(subsystem: "com.soulsniper.codenotch", category: "sessions")
}
