...
enum ReleaseNotes {
    static let all: [ReleaseNote] = [
        ReleaseNote(
            version: "1.4.0",
            headline: "Multi-account Claude Code, GLM provider, 15 integrations, and community reliability fixes.",
            changes: [
                ReleaseNote.Change(
                ...
                ReleaseNote.Change(
                    title: "15 AI Providers supported",
                    detail: "Monitor Claude, Cursor, Codex, Antigravity, GLM, Grok, Copilot, "
                          + "OpenRouter, DeepSeek, OpenAI, Windsurf, Ollama, Groq, Mistral, and Perplexity."
                )
            ]
        ),
        ReleaseNote(
